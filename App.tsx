...
const App: React.FC = () => {
  ...
  const loadPortfolioData = async () => {
    try {
      ...
      if (supabaseData && supabaseData.experiences && supabaseData.experiences.length > 0) {
        ...
        localStorage.setItem('dev_portfolio_experiences', JSON.stringify(supabaseData.experiences || defaultExperiences));
        localStorage.setItem('dev_portfolio_education', JSON.stringify(supabaseData.education || defaultEducation));
        localStorage.setItem('dev_portfolio_skills', JSON.stringify(supabaseData.skills || defaultSkills));
        return;
      }
      ...
      // Both Supabase and localStorage are empty - use defaults
      console.log('⚠️ Sin datos guardados, usando ejemplos');
      setExperiences(defaultExperiences);
      setEducation(defaultEducation);
      setSkills(defaultSkills);
      
      // Only save defaults if we're in admin mode
